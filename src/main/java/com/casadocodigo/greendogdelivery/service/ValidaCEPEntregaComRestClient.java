...
import com.casadocodigo.greendogdelivery.domain.CEP;
...
public class ValidaCEPEntregaComRestClient implements ValidaCEPEntrega {
	...
	private static final String LOCALIDADE_FIXA = "Recife";
	private static final String UF_FIXA = "PE";
	...
	public boolean processa(String cep) {
		...
		ResponseEntity<CEP> responseCEP = restClient.get().uri(urlBuscaCEP).retrieve().toEntity(CEP.class);
